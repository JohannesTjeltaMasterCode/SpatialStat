...
if __name__=='__main__':
    ...
    for parameter in parameterArray:
        ...
        ax.plot3D(rm[0],rm[1],rm[2],'.',label='Randomly distrebuted V={:1.3f}'.format(c3))
        ax.plot3D(rmc[0],rmc[1],rmc[2],'.',label='Semi clustering V={:1.3f}'.format(c2))
        ax.plot3D(rmc2[0],rmc2[1],rmc2[2],'.',label='Max clustering V={:1.3f}'.format(c1))
